...
and without sparsity. In this way, we can explain how the time is
...
actually one load per memtile for a total of four loads per activation
and four loads for weights. Because each load is to a different memtile,
they are parallel.  The activation and weight communications are using
two different channels and they are parallel with 4 GBps bandwidth.
...
computation, and write in parallel. This is a
