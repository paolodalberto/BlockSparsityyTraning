...
the code is available. A convolution will have three parameters
...
\begin{figure}[ht]
\begin{center}
  \subfloat{\includegraphics[width=0.99\linewidth]{images/vgg16ddronly.png}}
\end{center}
...
\begin{figure}[ht]
\begin{center}
  \subfloat{\includegraphics[width=0.99\linewidth]{images/vgg2tiles.png}}
\end{center}
...
\begin{figure}[ht]
\begin{center}
  \subfloat{\includegraphics[width=0.99\linewidth]{images/vgg2tilessparse.png}}
\end{center}
