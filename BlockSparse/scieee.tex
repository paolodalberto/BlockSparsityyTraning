...
\begin{abstract}
Inference is a synonymous for performance. The inference time is 
how long it takes for a forward propagation of a neural network.  
% for example, more and faster classifications per seconds.
 As faster and tailor-made
chip-lets are deployed in the field, Larger and larger models are
