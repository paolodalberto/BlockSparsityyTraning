...
different memory requirements, we try as much as possible to obtain as
symmetric computation as possible. If the convolution has strides and
large kernel, each sub-convolution may have overlap data but defined
...
\SSinglefigure{2.0}{singledenseconv.png}{Resnet single convolution
  with padding for 4x4 AIE }{fig:singleconvestimate}
...
\DDoublefigure{1.3}{IncV3-2x2-2share-dense.png}{IncV3-2x2-2share-sparse.png}{Inception for 2x2 AIE  with dense (left)  weights and sparse (right) }{fig:incv3-}
\DDoublefigure{1.3}{IncV3-3x3-3share-dense.png}{IncV3-3x3-3share-sparse.png}{Inception for 3x3 AIE  with dense (left)  weights and sparse (right) }{fig:incv3-}
\DDoublefigure{1.3}{IncV3-4x4-4share-dense.png}{IncV3-4x4-4share-sparse.png}{Inception for 4x4 AIE  with dense (left)  weights and sparse (right) }{fig:incv3-}
\SSinglefigure{2}{IncV3-5x5-5share-dense.png}{Inception for 5x5 AIE  with dense (left)  weights and sparse (right) }{fig:incv3-}
\DDoublefigure{1.3}{IncV3-6x6-6share-dense.png}{IncV3-6x6-6share-sparse.png}{Inception for 6x6 AIE  with dense (left)  weights and sparse (right) }{fig:incv3-}
\DDoublefigure{1.3}{IncV3-8x8-8share-dense.png}{IncV3-8x8-8share-sparse.png}{Inception for 8x8 AIE  with dense (left)  weights and sparse (right) }{fig:incv3-}

\DDoublefigure{1.3}{Res2x2-2share-dense.png}{Res2x2-2share-sparse.png}{Resnet for 2x2 AIE  with dense (left)  weights and sparse (right) }{fig:incv3-}
\DDoublefigure{1.3}{Res3x3-3share-dense.png}{Res3x3-3share-sparse.png}{Resnet for 3x3 AIE  with dense (left)  weights and sparse (right) }{fig:incv3-}
\DDoublefigure{1.3}{Res4x4-4share-dense.png}{Res4x4-4share-sparse.png}{Resnet for 4x46 AIE  with dense (left)  weights and sparse (right) }{fig:incv3-}
\SSinglefigure{2}{Res5x5-5share-sparse.png}{Resnet for 5x5 AIE  with dense (left)  weights and sparse (right) }{fig:incv3-}
\DDoublefigure{1.3}{Res6x6-6share-dense.png}{Res6x6-6share-sparse.png}{Resnet for 6x6 AIE  with dense (left)  weights and sparse (right) }{fig:incv3-}
