...
long it takes for a forward propagation of a neural network.  As
faster and tailor-made chip-lets are deployed in the field, larger and
larger models are domineering the public's attention: quantization and
