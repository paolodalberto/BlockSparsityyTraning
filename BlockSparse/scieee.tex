...
\Singlefigure{0.95}{AIE4x4sparse.png}{Resnet50 for 4x4 AIE with 50\%
  sparse weights}{fig:estimate-sparse}
\Singlefigure{0.95}{inceptionv3dense.png}{Inception V3 for 4x4 AIE
  with dense weights}{fig:incv3-estimate-dense}
\Singlefigure{0.95}{inceptionv3sparse.png}{Inception V3 for 4x4 AIE
  with 50\% sparse weights}{fig:estimate-sparse}
