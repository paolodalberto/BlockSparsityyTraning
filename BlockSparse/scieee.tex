...
alike. A $4\times 4$ cohort will have 4 units in a $8\times 8$ with 2
memtiles per columns. This a board should have about 4*10 images
computed in parallel on a VCK board. 
...
\DDoublefigure{1.3}{IncV3-6x6-6share-dense.png}{IncV3-6x6-6share-sparse.png}{Inception
  for 6x6 AIE with dense (left) weights and sparse (right)
}{fig:incv3-5}
\DDoublefigure{1.3}{IncV3-8x8-8share-dense.png}{IncV3-8x8-8share-sparse.png}{Inception
  for 8x8 AIE with dense (left) weights and sparse (right)
}{fig:incv3-6}
